...
def letter_stat(our_str):
    """
    Принимаем строку и возращаем словарь, у которого в качестве ключей  - буквы строки, а значениями являются числа,
    соответствующие количеству вхождений данной буквы в строку.
    Например (Ввод --> Вывод) :
    'letter' --> {'l': 1, 'e': 2, 't': 2, 'r': 1}
    :param our_str: Входящая строка
    :return: Возвращаемый словарь в соответствии с требованиями.
    """
